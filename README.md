...
and Rohit Babu Gaddeti added accessing parsed data and storing it in database.(currently it'll save accessed data as a file but will be updated to store data into firebase or similar kind of thing)
